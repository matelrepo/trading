...
public class MacroReponseHandler {
    ...
    private MacroDataRepo macroDataRepo;

    public MacroReponseHandler(MacroDataRepo macroDataRepo){
        this.macroDataRepo = macroDataRepo;
    }
    ...
    public void processResponse(String json) throws IOException {
        ...
        List<MacroData> data = macroDataRepo.findByCode(code);
        ...
        if (newItems.size() > 0) {
            synchronized (this) {
                macroDataRepo.saveAll(newItems);
            }
        }
